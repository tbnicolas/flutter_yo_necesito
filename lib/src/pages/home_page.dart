    ...
    return new Container(
      ...
      child: new Row(
        ...
        children: [
          ...
          new CustomNavigationBar(icon: FontAwesomeIcons.commentDots, color: Colors.black87,),
          new CustomNavigationBar(icon: Icons.add_circle_outline_rounded,size: 40.0 ,color: Color(0xffED8306),border: true,),
          new CustomNavigationBar(icon:  FontAwesomeIcons.handshake, color: Colors.black87),
          new CustomNavigationBar(icon:  FontAwesomeIcons.user ,color: Colors.black87),
        ],
      ),
    );
